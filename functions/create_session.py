...
from functions.SC_Functions import userinfo
from functions.web_directories import instagram as instagram
##############################################
...
async def create_Session(playwright: Playwright, info, media) -> None:
    ...
    try:
        ...
        log("NEW SESSION: Two-Factor Authentication is not enabled", "u")
    finally:
